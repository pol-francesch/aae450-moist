...
theta_2_direct_lim = 60 + attitude;
...
plot(i_r,r_rec(4,:),'y','LineWidth',1.2)
...
title('Orbit Tradespace for SWE L-Band Phase')
...
legend('Iridium(L) Upper Lim','GPS(L) Upper Lim','Galileo(L) Upper Lim',...
    'GLONASS(L) Upper Lim','MoIST Orbit 1 (alt = 350 km, inc = 80 degs)',...
