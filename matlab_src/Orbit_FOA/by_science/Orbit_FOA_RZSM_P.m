...
theta_1_lim = 60; % sets incidence angle constraint
theta_2_lim = 60 + attitude; % sets reciever antenna(s) cone constraint
theta_3_lim = 180 - theta_1_lim; % sets compliment of incidence constraint
r_earth = 6378;
...
title('Orbit Tradespace for RZSM (VHF or P-Band)')
subtitle('Assumes Nadir Pointing and Visibility up to 70 degs Latitude')
xlabel('Inclination [degs]')
ylabel('Altitude [km]')
legend('MUOS(P) Upper Lim','ORBCOMM(I) Upper Lim','SWARM(I) Lower Lim',...
