...
figure
plot(i_r,r_rec(2,:),'b',i_r,r_rec(3,:),'g',i_r,r_rec(4,:),'c','LineWidth',1.2)
hold on
plot(inc,inc_transition,'r','LineWidth',1.2)
title('GEO Constellations for L-Band Requirements')
...
hold on
plot(inc,inc_transition,'r','LineWidth',1.2)
title('LEO Constellations for L-Band Requirements')
subtitle('Must be ABOVE red curve and BELOW constellation curves')
xlabel('Inclination [degs]')
ylabel('Altitude [km]')
